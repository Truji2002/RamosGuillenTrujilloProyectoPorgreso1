...
namespace RamosGuillenTrujilloProyectoPorgreso1.Controllers
{
    public class RutasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdRuta,FechaEmisionLicencia,FechaVencimientoLicencia,PuntoPartida,PuntoLlegada,Precio,FechaPartida,Tipo,Modelo,Matricula,Capacidad")] Ruta ruta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdRuta,FechaEmisionLicencia,FechaVencimientoLicencia,PuntoPartida,PuntoLlegada,Precio,FechaPartida,Tipo,Modelo,Matricula,Capacidad")] Ruta ruta)
        {
            if (id != ruta.IdRuta)
            {
                return NotFound();
