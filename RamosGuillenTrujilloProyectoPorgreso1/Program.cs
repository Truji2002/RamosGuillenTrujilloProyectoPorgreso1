...
builder.Services.AddDbContext<RamosGuillenTrujilloProyectoPorgreso1Context5>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("RamosGuillenTrujilloProyectoPorgreso1Context5Connection") ?? throw new InvalidOperationException("Connection string 'RamosGuillenTrujilloProyectoPorgreso1Context5' not found.")));
